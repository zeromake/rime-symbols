...
def genSymbolWord(file_name):
    text = ''
    text += genTextTypeWord('全音符', '𝅝')
    text += genTextTypeWord('二分音符', '𝅗𝅥')
    text += genTextTypeWord('四分音符', '𝅘𝅥')
    text += genTextTypeWord('八分音符', '𝅘𝅥𝅮')
    text += genTextTypeWord('十六分音符', '𝅘𝅥𝅯')
    text += genTextTypeWord('三十二分音符', '𝅘𝅥𝅰')
    text += genTextTypeWord('六十四分音符', '𝅘𝅥𝅱')
    text += genTextTypeWord('一百二十八分音符', '𝅘𝅥𝅲')

    text += genTextTypeWord('全休止符', '𝄻')
    text += genTextTypeWord('二分休止符', '𝄼')
    text += genTextTypeWord('四分休止符', '𝄽')
    text += genTextTypeWord('八分休止符', '𝄾')
    text += genTextTypeWord('十六分休止符', '𝄿')
    text += genTextTypeWord('三十二分休止符', '𝅀')
    text += genTextTypeWord('六十四分休止符', '𝅁')
    text += genTextTypeWord('一百二十八分休止符', '𝅂')

    text += genTextTypeWord('升记号', '♯')
    text += genTextTypeWord('降记号', '♭')
    text += genTextTypeWord('还原记号', '♮')
    text += genTextTypeWord('重升记号', '𝄪')
    text += genTextTypeWord('重降记号', '𝄫')

    text += genTextTypeWord('高音谱号', '𝄞')
    text += genTextTypeWord('低音谱号', '𝄢')
